        ...
        <div className=' w-full min-h-[100vh] mb-[10vh] '>
            ...
            <section className='w-full flex flex-col gap-5 mt-28'>
                ...
                <div className='w-full flex  gap-5 flex-wrap'>
                    {
                        products.reverse().slice(0,Math.min(6,products?.length)).map((food) => <FoodCard key={food.id} food={food} />)
                    }
                ...
                <div className='flex gap-5 flex-wrap'>
                    {
                        ...
                        customerFeedbackData.map((feedback) => <FeedbackCard key={feedback.id} feedback={feedback} />)
                    }
                </div>
